...
const SETTINGS_STORAGE_KEY = 'castle-role.settings.v1';
      ...
      <div class="privacy-content">
        <article id="privacy-policy" class="privacy-document">
          ...
          <ul>
            ...
            <li><strong>Settings:</strong> gameplay, graphics, audio, and interface preferences are stored locally under <code>castle-role.settings.v1</code>.</li>
        ...
        <article id="data-storage" class="privacy-document">
          ...
          <div class="privacy-data-card">
            ...
            <span>Local browser storage · <code>castle-role.settings.v1</code></span>
